...
Node.js
  ...
  developed using the v24 Long Term Support release of Node.js.  The
  ...
  ``nvm``, you can do ``nvm install v24`` to set up the appropriate
  version of node.
...
<https://github.com/nvm-sh/nvm>`_ and install node v24 by running
